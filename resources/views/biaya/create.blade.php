            ...
            <form action="{{ route('biaya.store') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control form-control-sm" name="tanggal_transaksi" id=""
                           aria-describedby="helpId" placeholder="" value="{{ old('tanggal_transaksi') }}">
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Keterangan</label>
                    <input type="text" class="form-control form-control-sm" name="keterangan" id=""
                           aria-describedby="helpId" placeholder="" value="{{ old('keterangan') }}">
                </div>
